"""
Django settings for courier_site_project project.
...
SECRET_KEY = 'django-insecure-qv*bqzt7k!(!f!*nprm#9f0oeel6f5baihfho5b(=b%4^9rcd*'
...
DEFAULT_FROM_EMAIL = "no-reply@quariarbox.com"
